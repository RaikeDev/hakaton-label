...
type Page = "dashboard" | "catalog" | "analytics" | "syncs" | "balance" | "approvals" | "payments" | "upload" | "artists" | "admin-payments" | "admin-approvals" | "admin-syncs";
...
function AppShell() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden" style={{ background: "#08080E", color: "#E5E7EB", fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
      ...
      <main className="flex-1 overflow-hidden flex flex-col min-w-0">
        ...
        {(page === "artists" || page === "admin-payments" || page === "admin-approvals" || page === "admin-syncs") && (
          <div className="flex-1 flex items-center justify-center flex-col gap-3">
            <p className="text-[#6B7280] text-lg">Раздел в разработке</p>
